    ...
    extends ViewGroup
  {
    ...
    public void add(View paramView)
    {
      ...
      if ((paramView.getParent() instanceof ViewGroup))
      {
        ...
        if ((localViewGroup != this.hostView) && (localViewGroup.getParent() != null) && (a0.O(localViewGroup)))
        {
          int[] arrayOfInt1 = new int[2];
          int[] arrayOfInt2 = new int[2];
          localViewGroup.getLocationOnScreen(arrayOfInt1);
          this.hostView.getLocationOnScreen(arrayOfInt2);
          a0.V(paramView, arrayOfInt1[0] - arrayOfInt2[0]);
          a0.W(paramView, arrayOfInt1[1] - arrayOfInt2[1]);
        }
