...
public class ShadowRenderer
{
  ...
  public void drawCornerShadow(Canvas paramCanvas, Matrix paramMatrix, RectF paramRectF, int paramInt, float paramFloat1, float paramFloat2)
  {
    ...
    localObject[1] = f1;
    localObject[2] = (f2 + f1);
    this.cornerShadowPaint.setShader(new RadialGradient(paramRectF.centerX(), paramRectF.centerY(), paramRectF.width() / 2.0F, cornerColors, (float[])localObject, Shader.TileMode.CLAMP));
    paramCanvas.save();
  ...
  {
    this.shadowStartColor = c.f(paramInt, 68);
    this.shadowMiddleColor = c.f(paramInt, 20);
    this.shadowEndColor = c.f(paramInt, 0);
