  ...
  extends androidx.appcompat.graphics.drawable.a
{
  ...
  {
    super(paramDrawable);
    this.shadowStartColor = androidx.core.content.a.c(paramContext, R.color.design_fab_shadow_start_color);
    this.shadowMiddleColor = androidx.core.content.a.c(paramContext, R.color.design_fab_shadow_mid_color);
    this.shadowEndColor = androidx.core.content.a.c(paramContext, R.color.design_fab_shadow_end_color);
  ...
  private void buildShadowCorners()
  {
    ...
    if (f2 > 0.0F)
    {
      ...
      ((Paint)localObject2).setShader(new RadialGradient(0.0F, 0.0F, f2, new int[] { 0, i, j, k }, new float[] { 0.0F, f1, f3 + f1, 1.0F }, localTileMode));
    }
    ...
    int j = this.shadowEndColor;
    localObject1 = Shader.TileMode.CLAMP;
    ((Paint)localObject2).setShader(new LinearGradient(0.0F, f1, 0.0F, f2, new int[] { i, k, j }, new float[] { 0.0F, 0.5F, 1.0F }, (Shader.TileMode)localObject1));
