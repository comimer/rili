  ...
  extends Transition
{
  ...
  public Animator createAnimator(ViewGroup paramViewGroup, final TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    if ((paramTransitionValues1 != null) && (paramTransitionValues2 != null))
    {
      ...
      if (localRectF1 != null)
      {
        ...
        if (localRectF2 != null)
        {
          paramTransitionValues1 = (ShapeAppearanceModel)paramTransitionValues1.values.get("materialContainerTransition:shapeAppearance");
          paramTransitionValues2 = (ShapeAppearanceModel)paramTransitionValues2.values.get("materialContainerTransition:shapeAppearance");
          ...
          paramTransitionValues1 = new TransitionDrawable(getPathMotion(), localView1, localRectF1, paramTransitionValues1, getElevationOrDefault(this.startElevation, localView1), localView2, localRectF2, paramTransitionValues2, getElevationOrDefault(this.endElevation, localView2), this.containerColor, this.startContainerColor, this.endContainerColor, this.scrimColor, bool, this.elevationShadowEnabled, FadeModeEvaluators.get(this.fadeMode, bool), FitModeEvaluators.get(this.fitMode, bool, localRectF1, localRectF2), buildThresholdsGroup(bool), this.drawDebugEnabled, null);
          paramTransitionValues1.setBounds(Math.round(paramViewGroup.left), Math.round(paramViewGroup.top), Math.round(paramViewGroup.right), Math.round(paramViewGroup.bottom));
          ...
          paramViewGroup.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
          {
            ...
            {
              MaterialContainerTransform.TransitionDrawable.access$200(paramTransitionValues1, paramAnonymousValueAnimator.getAnimatedFraction());
            }
          });
          addListener(new TransitionListenerAdapter()
          {
            public void onTransitionEnd(Transition paramAnonymousTransition)
            {
              ...
              ViewUtils.getOverlay(localView3).remove(paramTransitionValues1);
            }
            
            public void onTransitionStart(Transition paramAnonymousTransition)
            {
              ViewUtils.getOverlay(localView3).add(paramTransitionValues1);
    ...
    extends Drawable
  {
    ...
    private TransitionDrawable(PathMotion paramPathMotion, View paramView1, RectF paramRectF1, ShapeAppearanceModel paramShapeAppearanceModel1, float paramFloat1, View paramView2, RectF paramRectF2, ShapeAppearanceModel paramShapeAppearanceModel2, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, FadeModeEvaluator paramFadeModeEvaluator, FitModeEvaluator paramFitModeEvaluator, MaterialContainerTransform.ProgressThresholdsGroup paramProgressThresholdsGroup, boolean paramBoolean3)
    {
      ...
      paramPathMotion = new PathMeasure(paramPathMotion.getPath(paramView1.x, paramView1.y, paramRectF1.x, paramRectF1.y), false);
    ...
    private void updateProgress(float paramFloat)
    {
      ...
      f2 = ((Float)h.g(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).start))).floatValue();
      f1 = ((Float)h.g(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).end))).floatValue();
