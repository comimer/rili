...
class FloatingActionButtonImpl
{
  ...
  {
    boolean bool;
    if ((a0.P(this.view)) && (!this.view.isInEditMode())) {
      bool = true;
    } else {
      bool = false;
    }
  ...
  void initializeBackgroundDrawable(ColorStateList paramColorStateList1, PorterDuff.Mode paramMode, ColorStateList paramColorStateList2, int paramInt)
  {
    ...
    this.contentBackground = new LayerDrawable(new Drawable[] { (Drawable)h.g(this.shapeDrawable), paramColorStateList1 });
  }
  ...
  void setRippleColor(ColorStateList paramColorStateList)
  {
    ...
    if (localDrawable != null) {
      a.o(localDrawable, RippleUtils.sanitizeRippleDrawableColor(paramColorStateList));
    }
  }
