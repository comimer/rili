...
public class ShapeAppearanceModel
{
  ...
  private static Builder builder(Context paramContext, int paramInt1, int paramInt2, CornerSize paramCornerSize)
  {
    ...
    try
    {
      ...
      i = paramContext.getInt(R.styleable.ShapeAppearance_cornerFamilyTopLeft, j);
      ...
      paramCornerSize = ((Builder)localObject2).setTopLeftCorner(i, paramCornerSize).setTopRightCorner(paramInt1, (CornerSize)localObject1).setBottomRightCorner(paramInt2, localCornerSize1).setBottomLeftCorner(j, localCornerSize2);
