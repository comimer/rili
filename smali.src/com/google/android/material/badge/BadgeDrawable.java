  ...
  implements TextDrawableHelper.TextDrawableDelegate
{
  ...
  private void updateCenterAndBounds()
  {
    ...
    if (localObject1 != null) {
      localObject1 = (View)((Reference)localObject1).get();
    } else {
      localObject1 = null;
    }
    if ((localContext != null) && (localObject1 != null))
    {
      ...
      if (localObject2 != null) {
        localViewGroup = (ViewGroup)((Reference)localObject2).get();
      }
  ...
  public void setBadgeGravity(int paramInt)
  {
    if (this.savedState.badgeGravity != paramInt)
    {
      ...
      if ((localObject != null) && (((Reference)localObject).get() != null))
      {
        ...
        if (localObject != null) {
          localObject = (ViewGroup)((Reference)localObject).get();
        } else {
          localObject = null;
        }
    ...
    implements Parcelable
  {
    ...
    {
      public BadgeDrawable.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
