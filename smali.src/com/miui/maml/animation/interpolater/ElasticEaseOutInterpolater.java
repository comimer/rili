  ...
  implements Interpolator
{
  ...
  public ElasticEaseOutInterpolater(float paramFloat1, float paramFloat2)
  {
    this.mPriod = paramFloat1;
    this.mAmplitude = paramFloat2;
  }
  
  public ElasticEaseOutInterpolater(Expression[] paramArrayOfExpression)
  {
    this.mAmplitude = 0.0F;
    this.mPriod = 0.3F;
  ...
  public float getInterpolation(float paramFloat)
  {
    ...
    return (float)(f1 * Math.pow(2.0D, -10.0F * paramFloat) * Math.sin((paramFloat - f2) * 6.283185307179586D / this.mPriod) + 1.0D);
  }
}


/* Location:           J:\AndroidKiller_v1.3.1\AndroidKiller_v1.3.1\projects\小米日历-v13.18.0.0\ProjectSrc\smali\
 * Qualified Name:     com.miui.maml.animation.interpolater.ElasticEaseOutInterpolater
