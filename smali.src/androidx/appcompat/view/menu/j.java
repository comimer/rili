  ...
  implements MenuItem
{
  ...
  public j(Context paramContext, u.b paramb)
  {
    super(paramContext);
    if (paramb != null)
    {
  ...
  {
    View localView1 = this.d.getActionView();
    View localView2 = localView1;
    if ((localView1 instanceof c)) {
      localView2 = ((c)localView1).a();
    }
    return localView2;
  }
    ...
    extends androidx.core.view.b
  {
    ...
    {
      this.d.onPrepareSubMenu(j.this.d(paramSubMenu));
    }
  }
    ...
    implements MenuItem.OnActionExpandListener
  {
    ...
    {
      return this.a.onMenuItemActionCollapse(j.this.c(paramMenuItem));
    }
    
    public boolean onMenuItemActionExpand(MenuItem paramMenuItem)
    {
      return this.a.onMenuItemActionExpand(j.this.c(paramMenuItem));
    }
  }
    ...
    implements MenuItem.OnMenuItemClickListener
  {
    ...
    {
      return this.a.onMenuItemClick(j.this.c(paramMenuItem));
    }
  }
}
