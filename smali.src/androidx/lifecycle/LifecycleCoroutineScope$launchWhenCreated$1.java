...
final class LifecycleCoroutineScope$launchWhenCreated$1
  extends SuspendLambda
  implements p<k0, c<? super u>, Object>
{
  int label;
  
  LifecycleCoroutineScope$launchWhenCreated$1(j paramj, p<? super k0, ? super c<? super u>, ? extends Object> paramp, c<? super 1> paramc)
  {
    super(2, paramc);
  }
  ...
  public final Object invokeSuspend(Object paramObject)
  {
    ...
    else
    {
      ...
      this.label = 1;
      if (PausingDispatcherKt.a(localLifecycle, paramObject, this) == localObject) {
        return localObject;
      }
    }
    return u.a;
 ...
 * Qualified Name:     androidx.lifecycle.LifecycleCoroutineScope.launchWhenCreated.1
