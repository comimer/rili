...
@Metadata(bv={}, d1={""}, d2={"Lu3/k;", "Lcom/miui/calendar/card/single/custom/ad/AdSingleCard;", "", "j", "", "i", "Ls3/a$a;", "Ls3/a;", "holder", "position", "Lkotlin/u;", "g", "", "", "", "params", "M", "Landroid/view/View;", "view", "h", "Landroid/content/Context;", "context", "Lcom/miui/calendar/card/Card$ContainerType;", "containerType", "Ljava/util/Calendar;", "desiredDay", "Landroid/widget/BaseAdapter;", "adapter", "<init>", "(Landroid/content/Context;Lcom/miui/calendar/card/Card$ContainerType;Ljava/util/Calendar;Landroid/widget/BaseAdapter;)V", "a", "b", "app_chinaNormalRelease"}, k=1, mv={1, 7, 1})
public final class k
  extends AdSingleCard
{
  public static final b A = new b(null);
  
  public k(Context paramContext, Card.ContainerType paramContainerType, Calendar paramCalendar, BaseAdapter paramBaseAdapter)
  {
    super(paramContext, 68, paramContainerType, paramCalendar, paramBaseAdapter);
  }
  
  private static final void X(k paramk, View paramView)
  {
    r.f(paramk, "this$0");
    paramView = d.d(paramk.a, paramk.t.appPrivacy);
    paramk.a.startActivity(paramView);
  }
  
  private static final void Y(k paramk, View paramView)
  {
    r.f(paramk, "this$0");
    paramView = d.d(paramk.a, paramk.t.appPermission);
    paramk.a.startActivity(paramView);
  }
  ...
  public void g(a.a parama, int paramInt)
  {
    ...
    if ((parama != null) && (this.t.appVersion != null)) {
      parama.setOnClickListener(new i(this));
    }
    parama = locala.I;
    if ((parama != null) && (this.t.appVersion != null)) {
      parama.setOnClickListener(new j(this));
    }
    localObject1 = locala.C;
    if (localObject1 != null)
    {
      parama = this.t;
      paramInt = parama.apkSize;
  ...
  @Metadata(bv={}, d1={""}, d2={"Lu3/k$a;", "Lcom/miui/calendar/card/single/custom/ad/AdSingleCard$e;", "Lcom/miui/calendar/card/single/custom/ad/AdSingleCard;", "Landroid/view/View;", "view", "<init>", "(Lu3/k;Landroid/view/View;)V", "app_chinaNormalRelease"}, k=1, mv={1, 7, 1})
  ...
  @Metadata(bv={}, d1={""}, d2={"Lu3/k$b;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "app_chinaNormalRelease"}, k=1, mv={1, 7, 1})
