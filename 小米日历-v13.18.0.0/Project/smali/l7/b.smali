...
# direct methods
.method public static a(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Ll7/a;)Lcom/xiaomi/settingsdk/backup/data/DataPackage;
    .locals 7
    ...
    .line 5
    .line 6
    invoke-interface {p2, p0, v0}, Ll7/a;->a(Landroid/content/Context;Lcom/xiaomi/settingsdk/backup/data/DataPackage;)V
    ...
    .line 66
    .line 67
    invoke-interface {p2, p0}, Ll7/a;->c(Landroid/content/Context;)I
    ...
    .line 106
    .line 107
    invoke-static {p0}, Ll7/b;->b(Ljava/io/OutputStream;)V
    ...
    .line 138
    :goto_3
    invoke-static {v5}, Ll7/b;->b(Ljava/io/OutputStream;)V
...
.method private static c(Ljava/io/Reader;)V
    .locals 0
...
.method public static d(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Ll7/a;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 94
    .line 95
    invoke-virtual {v3, v6, v5}, Lcom/xiaomi/settingsdk/backup/data/DataPackage;->addAbstractDataItem(Ljava/lang/String;Lcom/xiaomi/settingsdk/backup/data/SettingItem;)V
    ...
    .line 101
    :cond_2
    invoke-interface {p2, p0, v3, p1}, Ll7/a;->b(Landroid/content/Context;Lcom/xiaomi/settingsdk/backup/data/DataPackage;I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 104
    :cond_3
    invoke-static {v2}, Ll7/b;->c(Ljava/io/Reader;)V
    ...
    .line 132
    :goto_4
    invoke-static {v1}, Ll7/b;->c(Ljava/io/Reader;)V
