.class Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;
...
.method public constructor <init>(Lnet/fortuna/ical4j/transform/recurrence/ByDayRule;Lnet/fortuna/ical4j/model/parameter/Value;)V
    ...
    .line 1
    iput-object p1, p0, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->this$0:Lnet/fortuna/ical4j/transform/recurrence/ByDayRule;
    ...
    .line 5
    .line 6
    iput-object p2, p0, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->type:Lnet/fortuna/ical4j/model/parameter/Value;
...
.method public static synthetic a(Ljava/util/Calendar;Ljava/lang/Integer;)Z
    ...
    invoke-static {p0, p1}, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->lambda$apply$1(Ljava/util/Calendar;Ljava/lang/Integer;)Z
...
.method public static synthetic b(Lnet/fortuna/ical4j/model/WeekDay;)Ljava/lang/Integer;
    ...
    invoke-static {p0}, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->lambda$apply$0(Lnet/fortuna/ical4j/model/WeekDay;)Ljava/lang/Integer;
...
.method public bridge synthetic apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->apply(Lnet/fortuna/ical4j/model/Date;)Ljava/util/List;
...
.method public apply(Lnet/fortuna/ical4j/model/Date;)Ljava/util/List;
    ...
    .line 3
    iget-object v1, p0, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->this$0:Lnet/fortuna/ical4j/transform/recurrence/ByDayRule;
    ...
    .line 7
    iget-object v5, p0, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->this$0:Lnet/fortuna/ical4j/transform/recurrence/ByDayRule;
    ...
    new-instance v7, Lnet/fortuna/ical4j/transform/recurrence/f;

    invoke-direct {v7}, Lnet/fortuna/ical4j/transform/recurrence/f;-><init>()V

    invoke-interface {v5, v7}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v5

    new-instance v7, Lnet/fortuna/ical4j/transform/recurrence/g;

    invoke-direct {v7, v1}, Lnet/fortuna/ical4j/transform/recurrence/g;-><init>(Ljava/util/Calendar;)V
    ...
    iget-object v7, p0, Lnet/fortuna/ical4j/transform/recurrence/ByDayRule$WeeklyExpansionFilter;->type:Lnet/fortuna/ical4j/model/parameter/Value;

    invoke-static {v5, v7}, Lnet/fortuna/ical4j/util/Dates;->getInstance(Ljava/util/Date;Lnet/fortuna/ical4j/model/parameter/Value;)Lnet/fortuna/ical4j/model/Date;
